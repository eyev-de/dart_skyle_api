...
class SkyleClient extends $grpc.Client {
  static final _$calibrate =
      $grpc.ClientMethod<$0.CalibControlMessages, $0.CalibMessages>(
  ...
  static final _$positioning =
      $grpc.ClientMethod<$1.Empty, $0.PositioningMessage>(
          '/Skyle.Skyle/Positioning',
          ($1.Empty value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.PositioningMessage.fromBuffer(value));
  ...
  static final _$setButton =
      $grpc.ClientMethod<$0.ButtonActions, $0.ButtonActions>(
  ...
  static final _$deleteProfile =
      $grpc.ClientMethod<$0.Profile, $0.StatusMessage>(
  ...
  static final _$rawBinocularGaze =
      $grpc.ClientMethod<$1.Empty, $0.BinocularGaze>(
  ...
  $grpc.ResponseStream<$0.PositioningMessage> positioning($1.Empty request,
      {$grpc.CallOptions? options}) {
    return $createStreamingCall(
        _$positioning, $async.Stream.fromIterable([request]),
        options: options);
  }

  $grpc.ResponseStream<$0.Point> gaze($1.Empty request,
      {$grpc.CallOptions? options}) {
    return $createStreamingCall(_$gaze, $async.Stream.fromIterable([request]),
        options: options);
  }

  $grpc.ResponseStream<$0.TriggerMessage> trigger($1.Empty request,
      {$grpc.CallOptions? options}) {
    return $createStreamingCall(
        _$trigger, $async.Stream.fromIterable([request]),
        options: options);
  }

  $grpc.ResponseFuture<$0.Button> getButton($1.Empty request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getButton, request, options: options);
  }

  $grpc.ResponseFuture<$0.ButtonActions> setButton($0.ButtonActions request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$setButton, request, options: options);
  }

  $grpc.ResponseFuture<$0.Options> configure($0.OptionMessage request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$configure, request, options: options);
  }

  $grpc.ResponseFuture<$0.DeviceVersions> getVersions($1.Empty request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getVersions, request, options: options);
  }

  $grpc.ResponseStream<$0.Profile> getProfiles($1.Empty request,
      {$grpc.CallOptions? options}) {
    return $createStreamingCall(
        _$getProfiles, $async.Stream.fromIterable([request]),
        options: options);
  }

  $grpc.ResponseFuture<$0.Profile> currentProfile($1.Empty request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$currentProfile, request, options: options);
  }

  $grpc.ResponseFuture<$0.StatusMessage> setProfile($0.Profile request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$setProfile, request, options: options);
  }

  $grpc.ResponseFuture<$0.StatusMessage> deleteProfile($0.Profile request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseStream<$0.RawImage> rawImages($1.Empty request,
      {$grpc.CallOptions? options}) {
    return $createStreamingCall(
        _$rawImages, $async.Stream.fromIterable([request]),
        options: options);
  }

  $grpc.ResponseStream<$0.BinocularGaze> rawBinocularGaze($1.Empty request,
      {$grpc.CallOptions? options}) {
    return $createStreamingCall(
        _$rawBinocularGaze, $async.Stream.fromIterable([request]),
        options: options);
  }
}
...
abstract class SkyleServiceBase extends $grpc.Service {
  ...
  SkyleServiceBase() {
    $addMethod($grpc.ServiceMethod<$0.CalibControlMessages, $0.CalibMessages>(
        ...
        true,
        ($core.List<$core.int> value) =>
            $0.CalibControlMessages.fromBuffer(value),
  ...
  $async.Stream<$0.Point> gaze_Pre(
      $grpc.ServiceCall call, $async.Future<$1.Empty> request) async* {
    yield* gaze(call, await request);
  }

  $async.Stream<$0.TriggerMessage> trigger_Pre(
      $grpc.ServiceCall call, $async.Future<$1.Empty> request) async* {
    yield* trigger(call, await request);
  }

  $async.Future<$0.Button> getButton_Pre(
      $grpc.ServiceCall call, $async.Future<$1.Empty> request) async {
    return getButton(call, await request);
  }

  $async.Future<$0.ButtonActions> setButton_Pre(
      $grpc.ServiceCall call, $async.Future<$0.ButtonActions> request) async {
    return setButton(call, await request);
  }

  $async.Future<$0.Options> configure_Pre(
      $grpc.ServiceCall call, $async.Future<$0.OptionMessage> request) async {
    return configure(call, await request);
  }

  $async.Future<$0.DeviceVersions> getVersions_Pre(
      $grpc.ServiceCall call, $async.Future<$1.Empty> request) async {
    return getVersions(call, await request);
  }

  $async.Stream<$0.Profile> getProfiles_Pre(
      $grpc.ServiceCall call, $async.Future<$1.Empty> request) async* {
    yield* getProfiles(call, await request);
  }

  $async.Future<$0.Profile> currentProfile_Pre(
      $grpc.ServiceCall call, $async.Future<$1.Empty> request) async {
    return currentProfile(call, await request);
  }

  $async.Future<$0.StatusMessage> setProfile_Pre(
      $grpc.ServiceCall call, $async.Future<$0.Profile> request) async {
    return setProfile(call, await request);
  }

  $async.Future<$0.StatusMessage> deleteProfile_Pre(
      $grpc.ServiceCall call, $async.Future<$0.Profile> request) async {
    return deleteProfile(call, await request);
  }

  $async.Future<$0.StatusMessage> reset_Pre(
      $grpc.ServiceCall call, $async.Future<$0.ResetMessage> request) async {
    return reset(call, await request);
  }

  $async.Stream<$0.RawImage> rawImages_Pre(
      $grpc.ServiceCall call, $async.Future<$1.Empty> request) async* {
    yield* rawImages(call, await request);
  }

  $async.Stream<$0.BinocularGaze> rawBinocularGaze_Pre(
      $grpc.ServiceCall call, $async.Future<$1.Empty> request) async* {
    yield* rawBinocularGaze(call, await request);
  }

  $async.Stream<$0.CalibMessages> calibrate(
      $grpc.ServiceCall call, $async.Stream<$0.CalibControlMessages> request);
  $async.Stream<$0.PositioningMessage> positioning(
      $grpc.ServiceCall call, $1.Empty request);
  $async.Stream<$0.Point> gaze($grpc.ServiceCall call, $1.Empty request);
  $async.Stream<$0.TriggerMessage> trigger(
      $grpc.ServiceCall call, $1.Empty request);
  $async.Future<$0.Button> getButton($grpc.ServiceCall call, $1.Empty request);
  $async.Future<$0.ButtonActions> setButton(
      $grpc.ServiceCall call, $0.ButtonActions request);
  $async.Future<$0.Options> configure(
      $grpc.ServiceCall call, $0.OptionMessage request);
  $async.Future<$0.DeviceVersions> getVersions(
      $grpc.ServiceCall call, $1.Empty request);
  $async.Stream<$0.Profile> getProfiles(
      $grpc.ServiceCall call, $1.Empty request);
  $async.Future<$0.Profile> currentProfile(
      $grpc.ServiceCall call, $1.Empty request);
  $async.Future<$0.StatusMessage> setProfile(
      $grpc.ServiceCall call, $0.Profile request);
  $async.Future<$0.StatusMessage> deleteProfile(
      $grpc.ServiceCall call, $0.Profile request);
  ...
  $async.Stream<$0.RawImage> rawImages(
      $grpc.ServiceCall call, $1.Empty request);
  $async.Stream<$0.BinocularGaze> rawBinocularGaze(
      $grpc.ServiceCall call, $1.Empty request);
}

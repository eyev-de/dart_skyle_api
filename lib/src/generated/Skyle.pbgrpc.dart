...
class SkyleClient extends $grpc.Client {
  ...
  static final _$configure = $grpc.ClientMethod<$0.OptionMessage, $0.Options>(
      ...
      $0.Options.fromBuffer);
  static final _$configureStream =
      $grpc.ClientMethod<$0.OptionMessage, $0.Options>(
  ...
  static final _$cursorCalibration =
      $grpc.ClientMethod<$0.CalibCursorMessages, $2.Point>(
          '/Skyle.Skyle/CursorCalibration',
          ($0.CalibCursorMessages value) => value.writeToBuffer(),
          $2.Point.fromBuffer);
  static final _$rawImages = $grpc.ClientMethod<$1.Empty, $2.Mat>(
...
abstract class SkyleServiceBase extends $grpc.Service {
  ...
  SkyleServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$1.Empty, $2.Mat>(
        ...
        true,
        ($core.List<$core.int> value) => $1.Empty.fromBuffer(value),
        ($2.Mat value) => value.writeToBuffer()));
  ...
  $async.Stream<$0.Options> configureStream(
      $grpc.ServiceCall call, $async.Stream<$0.OptionMessage> request);
  ...
  $async.Stream<$2.Point> cursorCalibration(
      $grpc.ServiceCall call, $async.Stream<$0.CalibCursorMessages> request);

  $async.Stream<$2.Mat> rawImages_Pre(
      $grpc.ServiceCall $call, $async.Future<$1.Empty> $request) async* {
